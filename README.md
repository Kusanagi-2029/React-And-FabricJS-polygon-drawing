...
> Нет необходимости подключать MobX, Tanstack Query, Redux Tool Kit, Effector, Zustand, Reatom и пр.
> К сожалению, здесь нечего валидировать, разбивать на страницы (роутинг) и сохранять в locac storage, следовательно, это было принято также не вводить по принципам **KISS** и **YAGNI**.
