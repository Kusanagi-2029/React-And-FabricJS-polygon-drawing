...
/**
 * Компонент для отрисовки многоугольников на холсте.
 *
 * Этот компонент управляет состоянием отрисовки, добавляет и удаляет обработчики событий для отрисовки на холсте,
 * а также включает панель управления для запуска/остановки отрисовки и очистки холста.
 *
 * @component
 */
const PolygonDrawer: FC = () => {
  ...
  /**
   * Эффект для инициализации и очистки холста.
  ...
  /**
   * Хук для обработки изменения размеров окна и изменения размеров холста.
   */
  useResizeCanvas(setCanvasWidth, setCanvasHeight);

  /**
   * Колбэк для обработки клика по холсту.
  ...
  /**
   * Колбэк для обработки движения мыши по холсту.
   * Создаётся с использованием `useCallback` для предотвращения лишних перерисовок.
   */
  ...
  /**
   * Эффект для установки и удаления обработчиков событий на холсте.
